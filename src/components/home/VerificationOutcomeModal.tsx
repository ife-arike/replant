      ...
      <View style={styles.scrim}>
        <View style={styles.card} accessibilityViewIsModal>
          ...
          <Text style={styles.lead}>
            After review, your registration could not be verified at this time.
          </Text>

          {/* Reason + close — OMITTED for safety_concern (trauma-aware silence) */}
          {!isSafety && (
            <>
...
const styles = StyleSheet.create({
  ...
  reason: { fontFamily: Typography.body, fontSize: 13.5, color: Colors.textMuted, lineHeight: 23, marginBottom: 14 },
