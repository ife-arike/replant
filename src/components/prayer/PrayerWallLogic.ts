...
// Founder bug 2026-06-18: resolve_display_name in the DB already
// prepends the role/honorific prefix to leaderDisplayName (e.g.
// "Pastor Priya"). Re-prefixing here produced "Pastor Pastor Priya"
// across every Prayer Wall surface. BE owns the canonical display
// string; FE just passes it through. `leaderRole` retained for
// signature compatibility (callers don't need to change).
