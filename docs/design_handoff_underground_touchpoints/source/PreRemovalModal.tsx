    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onAcknowledge}>
      <View style={styles.scrim}>
        <View style={styles.card}>
          ...
          <Text style={styles.title}>We don’t want to lose your registration</Text>
          ...
          <TouchableOpacity style={styles.ghost} onPress={onAcknowledge} activeOpacity={0.7}>
...
const styles = StyleSheet.create({
  ...
  body: { fontFamily: Typography.body, fontSize: 13.5, color: Colors.textMuted, fontWeight: '300', lineHeight: 23, marginBottom: Spacing.md },
