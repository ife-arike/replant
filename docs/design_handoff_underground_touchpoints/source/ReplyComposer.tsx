...
//     route (admin §3), then show the green "sent" takeover and auto-return Home.
...
//
// May be implemented as step 2 of RequestInfoModal rather than a separate route.
// ─────────────────────────────────────────────
  ...
  if (sent) {
    return (
      <SafeAreaView style={styles.sentRoot} edges={['top', 'bottom']}>
        ...
        <Text style={styles.sentTitle}>Your reply was sent to the team.</Text>
        <Text style={styles.sentSub}>They’ll review it with care. You can close the app — we’ll let you know here.</Text>
      </SafeAreaView>
    );
  }
  ...
  return (
    <SafeAreaView style={styles.root} edges={['top', 'bottom']}>
      <View style={styles.head}>
        ...
        <Text style={styles.title}>Your reply</Text>
      </View>
      ...
      <View style={styles.body}>
        ...
        />
        <Text style={styles.footNote}>Only the Replant team will see this. Take your time — there’s no rush.</Text>
      </View>
      ...
      <View style={styles.foot}>
        <TouchableOpacity
          ...
          activeOpacity={0.85}
        >
          <Text style={[styles.ctaText, !canSend && styles.ctaTextOff]}>Send reply</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  sentSub: { fontFamily: Typography.body, fontSize: 13.5, color: Colors.textMuted, fontWeight: '300', textAlign: 'center', lineHeight: 22, maxWidth: 240 },
});
