  ...
  return (
    <div className="thread-view">
      ...
      <div className="composer">
        <div className="attach" onClick={() => onToast && onToast('Attachments are coming soon. Sharing files will require consent and must follow the Replant community standard.')} title="Attachments coming soon"><Icon.clip /></div>
        <textarea
          ref={taRef}
          className="field"
          rows={1}
