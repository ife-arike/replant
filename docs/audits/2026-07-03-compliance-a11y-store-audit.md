...
9. **Audit-log 30-day age-out: ruled 2026-06-30, unbuilt** (no cron, no function — verified live). Life-safety + escalated reads retained forever is the locked ruling and must be *disclosed*; the age-out is a build-or-don't-promise fork for counsel.
...
**Founder + SEC:**
4. Mapbox telemetry Path 1 (disable at startup; proxy-capture evidence to the panel). Recommended: adopt.
...
12. Content-plane retention wording; audit-log age-out build-or-disclose; Play Health-info row.
...
13. NEW — Audit-log 30-day age-out cron (or disclose indefinite — LEGAL fork).
14. NEW — Website lead lifecycle (Netlify Forms + Google Sheet retention/deletion story).
15. KAN-157 — correct the "end-to-end encrypted" description (comment).
