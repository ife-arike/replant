...
function ChurchTabApp() {
  ...
  const pickGlobalRegion = () => {
    // pick a dense region — let's say East Asia
    setRegional({
      name: 'East Asia',
      churches: window.GLOBAL_CHURCHES.filter(c =>
        ['g14', 'g15', 'g16', 'g36', 'g37', 'g38'].includes(c.id)
      ),
    });
    setRegionalOpen(true);
  };
          ...
          <div className="tc-pages-track">
            ...
            <div className="tc-page">
              <div className="cal">
                ...
                />
                {/* region hint button — invites tap-on-region */}
                <div
